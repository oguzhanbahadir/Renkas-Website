(function ($) {
	...
	$.attach('body:not(.preview) .b-carousel', function (i, element) {

		var min = 0.65
		var max = 0.85

		var outer = element.find('.b-carousel-item-background')
		var inner = element.find('.b-carousel-item-background .image')
